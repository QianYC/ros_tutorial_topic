...
let FibGoal = require('./FibGoal.js');
...
class FibActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FibGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FibActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = FibGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new FibGoal()
    }
