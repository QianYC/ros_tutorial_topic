...
let FibFeedback = require('./FibFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class FibActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FibFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FibActionFeedback(null);
    ...
    data.feedback = FibFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += FibFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FibActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = FibFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new FibFeedback()
    }
...
module.exports = FibActionFeedback;
